...
const Home = async () => {
  ...
  return (
    <main className="bg-[#F8F8F8] mt-[83px]">
      <section className="max-w-[1280px] mx-auto mb-[100px] relative">
        <div className="lg:flex lg:justify-between pt-[30px] px-5">
          <div>
          ...
          <div className="absolute lg:static top-8 right-0 flex gap-2 pr-5">
            <div>
              <button 
            ...
            <div>
              <button 
                ...
                href="">
                <FaFilter className="text-[#151617"/> <span
