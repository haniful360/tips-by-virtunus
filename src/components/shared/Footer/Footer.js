...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 bg-[#FFFFFF] shadow-2xl">
      <div
        className={`${montserrat.className} max-w-7xl mx-auto flex justify-between py-7`}
      >
        <div className="text-[#222222] text-[14px]">
          <img
            className="w-[200px] h-[50px]"
            src="https://tips.virtunus.com/_next/image?url=%2Fvirtunus-logo.svg&w=256&q=75"
            alt=""
          />
        ...
        <div>
          ...
          <div className="flex gap-[10px] mt-[10px]">
            <div className="w-[31px] h-[31px] bg-[#222222] rounded-full flex items-center justify-center">
              <span>
                <BsFacebook className="text-[#ffffff]" />
              </span>
            </div>
            <div className="w-[31px] h-[31px] bg-[#222222] rounded-full flex items-center justify-center">
              <span>
      ...
      {backToTop && (
        <button
          onClick={scrollUp}
          className="fixed flex items-center justify-center bottom-5 right-[57px] w-[50px] h-[50px] bg-[#4D4D4F] border-[.8px] border-[#D9D9D9] rounded-[5px]"
        >
